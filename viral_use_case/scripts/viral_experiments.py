...
de_prots_info = pd.read_csv('/workspaces/timed-hpc/viral_use_case/data/de_prots.csv')
...
# Define the inputs
source_sizes = [25, 100, 358]
target_sizes = [25, 100, 192]
...
for i in range(0, nreps):
    ...
    mlp_outfile = f"/workspaces/timed-hpc/viral_use_case/results/mlp_expcond_{idx}_replicate_{i}.csv"
    vae_outfile = f"/workspaces/timed-hpc/viral_use_case/results/vae_expcond_{idx}_replicate_{i}.csv"
    rf_outfile = f"/workspaces/timed-hpc/viral_use_case/results/rf_expcond_{idx}_replicate_{i}.csv"
